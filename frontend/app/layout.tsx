...
import { FlowerWrapper } from "@/components/flowers/flower-wrapper"
  ...
  if(css){
    ...
    <ErrorBoundary>
      <Suspense fallback={null}>
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem disableTransitionOnChange themes={["light", "dark", "march"]}>
          <CustomThemeApplier />
          <AuthProvider>
            <RouteGuard>
              {children}
